...
class MeasuresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create measure" do
    assert_difference('Measure.count') do
      post measures_url, params: { measure: { data: @measure.data, measurement_id: @measure.measurement_id } }, as: :json
    end
  ...
  test "should update measure" do
    patch measure_url(@measure), params: { measure: { data: @measure.data, measurement_id: @measure.measurement_id } }, as: :json
    assert_response 200
  end
